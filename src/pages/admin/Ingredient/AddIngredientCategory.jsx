...
const AddIngredientCategory = ({onSave}) => {
    const {message} = App.useApp();
    const [onSaving, setOnSaving] = useState(false);

    const onFinish = async (values) => {
        setOnSaving(true);
        const response = await apiInstance.post(apiEndpoint.admin.ingredientCategory.add, values).then((response) => {
